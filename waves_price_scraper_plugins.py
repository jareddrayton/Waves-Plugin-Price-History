...
if os.path.isfile('waves_price_history_plugins.csv') != True:
    
    with open('waves_price_history_plugins.csv', 'a', newline='', encoding='utf-8') as csvfile:
...
with open('waves_price_history_plugins.csv', 'r', newline='', encoding='utf-8') as csvfile:
